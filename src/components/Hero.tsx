  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden px-4 sm:px-6">
      ...
      <div className="relative z-10 text-center px-4 sm:px-6 max-w-5xl mx-auto w-full">
        ...
        <div className={`w-24 sm:w-32 h-px bg-accent mx-auto my-12 sm:my-16 opacity-60 transition-all duration-700 delay-300 ${isComplete ? 'opacity-60 scale-x-100' : 'opacity-0 scale-x-0'}`}></div>
      ...
      <div className="absolute bottom-8 sm:bottom-12 left-1/2 transform -translate-x-1/2 animate-float">
        <div className="w-5 sm:w-6 h-8 sm:h-10 border-2 border-muted-foreground/50 rounded-full flex justify-center p-2 transition-all duration-300 hover:border-accent/70">
          <div className="w-1 h-2 sm:h-3 bg-accent/70 rounded-full animate-[float_3s_ease-in-out_infinite]"></div>
        </div>
      </div>
    </section>
  );
